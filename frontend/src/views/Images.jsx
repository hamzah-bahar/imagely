export default function Images() {
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto animate-slide-in">
                    ...
                    <div className="hs-dropdown [--placement:bottom-right] relative inline-block">
                      ...
                      >
                        <div className="py-2 first:pt-0 last:pb-0">
                          ...
                          <a
                            className="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100"
                            href="#"
                          >
                            <svg
                      ...
                      >
                        <div className="divide-y divide-gray-200">
                          ...
                          >
                            <input
                              type="checkbox"
                              className="shrink-0 mt-0.5 border-gray-300 rounded-sm text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                    ...
                    <td className="h-px w-72 min-w-72 align-top">
                      <a className="block p-6" href="#">
                        <div className="flex gap-x-1 mb-2">
                          <svg
                            className="shrink-0 size-3 text-gray-800"
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                            fill="currentColor"
                        ...
                        <span className="block text-sm text-gray-500">
                          I bought this hat for my boyfriend, but then i found
                          out he cheated on me so I kept it and I love it!! I
                          wear it all the time and there is no problem with the
                          fit even though its a mens" hat.
                        </span>
                      </a>
                    </td>
                    <td className="size-px whitespace-nowrap align-top">
